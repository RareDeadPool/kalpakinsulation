...
const HeroSlider = () => {
  ...
  return (
    <div className="relative h-screen overflow-hidden bg-gradient-to-br from-red-900 via-red-800 to-red-900">
                  ...
                  {index === currentSlide && (
                    <>
                      ...
                      <div className="space-y-4">
                        ...
                        <p className="text-xl sm:text-2xl text-red-100 font-medium">
                          {slide.subtitle}
                        </p>
                        <p className="text-lg text-red-200 max-w-lg leading-relaxed">
                          {slide.description}
                        </p>
                      </div>
                      ...
                      <div className="grid grid-cols-3 gap-6 py-6">
                        <div className="text-center">
                          <div className="text-2xl sm:text-3xl font-bold text-white">{slide.stats.projects}</div>
                          <div className="text-sm text-red-200">Projects</div>
                        </div>
                        <div className="text-center">
                          <div className="text-2xl sm:text-3xl font-bold text-white">{slide.stats.experience}</div>
                          <div className="text-sm text-red-200">Experience</div>
                        </div>
                        <div className="text-center">
                          <div className="flex items-center justify-center space-x-1">
                            <span className="text-2xl sm:text-3xl font-bold text-white">{slide.stats.rating}</span>
                      ...
                      <div className="flex flex-col sm:flex-row gap-4">
                        <button className="group bg-white text-red-600 px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 hover:bg-red-50 hover:shadow-xl hover:-translate-y-1 flex items-center justify-center space-x-2">
                          <span>{slide.cta}</span>
                          <ChevronRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                        </button>
                        <button className="group bg-transparent border-2 border-white text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 hover:bg-white hover:text-red-600 flex items-center justify-center space-x-2">
      ...
      {/* Slide Counter */}
      <div className="absolute top-8 right-4 sm:right-8 z-30 bg-white/20 backdrop-blur-sm text-white px-4 py-2 rounded-full border border-white/30">
