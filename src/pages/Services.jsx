    ...
    <div className="pt-20">
      ...
      <section className="gradient-primary text-white section-padding relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 text-center relative z-10">
          <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold mb-6 sm:mb-8 fade-in">Our Services</h1>
      ...
      <section className="section-padding bg-primary-50">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 sm:mb-16">
            <h2 className="text-2xl sm:text-4xl font-bold text-gray-800 mb-4">Additional Services</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8">
            {additionalServices.map((service, index) => (
              <div key={index} className="bg-white rounded-lg shadow-lg p-6 sm:p-8 text-center hover-lift">
      ...
      <section className="section-padding">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 sm:mb-16">
            <h2 className="text-2xl sm:text-4xl font-bold text-gray-800 mb-4">Our Process</h2>
            <p className="text-base sm:text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {processSteps.map((step, index) => (
              <div key={index} className="relative">
                <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8 hover-lift h-full">
                  <div className="text-primary-500 text-3xl sm:text-4xl font-bold mb-4">{step.step}</div>
      ...
      <section className="bg-primary-500 text-white section-padding">
        <div className="container mx-auto px-4 sm:px-6 text-center">
          <h2 className="text-2xl sm:text-4xl font-bold mb-4 sm:mb-6">Need a Custom Solution?</h2>
