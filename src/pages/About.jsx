    ...
    <div className="pt-20">
      ...
      <section className="gradient-primary text-white section-padding relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <h1 className="text-5xl md:text-6xl font-bold mb-8 fade-in">About Kalpak Insulation</h1>
      ...
      <section className="section-padding bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-800 mb-6 fade-in">Our Foundation</h2>
      ...
      <section className="section-padding">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-800 mb-6 fade-in">Our Team</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto fade-in stagger-2">
          ...
          {/* Qualified Personnel */}
          <div className="mb-16">
            <h3 className="text-2xl font-bold text-gray-800 mb-8 text-center">Qualified Personnel with Designation</h3>
          ...
          {team.some(member => member.position === 'Worker') && (
            <div>
              <h3 className="text-2xl font-bold text-gray-800 mb-8 text-center">Our Workers</h3>
      ...
      <section className="section-padding bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-800 mb-6 fade-in">Our Journey</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto fade-in stagger-2">
          ...
          <div className="relative" ref={timelineRef}>
            ...
            {timeline.map((item, index) => (
              ...
              >
                <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-4 h-4 rounded-full bg-primary-500"></div>
